...
/**
*	string.replace replaces ONLY the 1st occurrence
* 	Ref: https://stackoverflow.com/questions/1144783/how-to-replace-all-occurrences-of-a-string-in-javascript
*/
function replaceAll(stringTobeCorrected,symbolToRemove,symbolToReplace){
	return stringTobeCorrected.split(symbolToRemove).join(symbolToReplace);
}